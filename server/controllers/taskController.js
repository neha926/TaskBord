...
// we can't find any project for that projectId
        if(!project){
            ...
            return res.status(403).json({ message : "Assignee is not the member of project or workspace"});
        }
